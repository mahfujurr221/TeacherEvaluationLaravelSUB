...
<div class="row mt-5">
  ...
  <div class="col-xl-8">
      <form method="post" action="{{url('dashboard/open/question/update')}}">
        @csrf
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>Add Open Question</div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-success add_admin_btn" href="{{url('dashboard/open/question')}}"><i class="fa fa-th"></i>All Question</a>
              </div>
            </div>
          </div>
