...
<div id="offered_courses"  class="row animate__animated animate__fadeInRightBig animate">
    <div class="col-md-12 main_content">
        <div class="card">
          <h2 class=" card-header text-center mt-2">All Teachers Reports</h2>
            <div class="card-body">
                      ...
                      @if(Auth::user()->dept_id==$data->dept_id)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-danger manage_btn delete_btn" href="{{url('dashboard/report/teacher/view/'.$data->tcr_id)}}"><i class="fa fa-th"></i>See Report</a>
                            </td>
                        </tr>
                        @endif
