...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2022 at 11:59 PM
...
(4, 'CSE0102', 'Computer Fundamental 2', '1', NULL, NULL, 'course206390566f3f8bb', 1, '2022-12-07 09:01:35', NULL);
...
(1, '1', '2022', '1', 1, '2022-12-08 22:50:29', '2022-12-08 22:50:29');
...
INSERT INTO `enroll_students` (`enroll_id`, `stu_id`, `stu_name`, `course_id`, `dept_id`, `tcr_id`, `enroll_slug`, `enroll_creator`, `evaluation_status`, `enroll_status`, `created_at`, `updated_at`) VALUES
(1, 'UG02-45-17-010', 'Mahfujur Rahman', '1', '1', '1', 'enroll206390eb7a91ed1', NULL, 1, 1, '2022-12-07 19:37:30', '2022-12-07 21:28:38');
...
(2, '2', 'Question Desccription 2', 'Very bad', 'bad', 'average', 'good', 'excellent', NULL, NULL, 'mcq206392542de3e53', 1, '2022-12-08 21:16:29', NULL),
(3, '3', 'Question Desccription 3', 'Very bad', 'bad', 'average', 'good', 'excellent', NULL, NULL, 'mcq206392544dbc360', 1, '2022-12-08 21:17:01', NULL),
(4, '1', 'This is question 2 Version 1', 'Very bad', 'bad', 'average', 'good', 'excellent', NULL, NULL, 'mcq2063926a20000bf', 1, '2022-12-08 22:50:08', NULL);
...
CREATE TABLE `mcq_responses` (
  ...
  `mcq_response` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(123, '2022_11_23_115549_create_enroll_students_table', 18),
(124, '2022_12_09_001719_create_mcq_responses_table', 19),
(125, '2022_12_09_002114_create_open_responses_table', 20);
...
(1, '1', '1', '1', '2022', '1', NULL, NULL, 'offercourse2063904080a7436', 0, 1, '2022-12-07 07:28:00', '2022-12-07 22:15:25'),
...
(2, '1', 'Question Desccription 2', NULL, NULL, 'mcq206392546a43654', 1, '2022-12-08 21:17:30', NULL),
(3, '1', 'Question Desccription 3', NULL, NULL, 'mcq2063925471a6943', 1, '2022-12-08 21:17:37', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `open_responses`
--
...
CREATE TABLE `open_responses` (
  ...
  `stu_id` varchar(255) NOT NULL,
  `question_id` int(11) NOT NULL,
  `open_response` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 'Student', 'role2063924aa571b6c', 1);
...
('UG02-45-17-006', '2', 'Ishraq', 'Ahmed', 'ishraq@gmail.com', 'stu-stu20638ae6e0c476f-1670047456.jpg', NULL, NULL, 'stu20638ae6e0c476f', 1, '2022-12-03 06:04:16', '2022-12-07 20:26:09'),
...
(1, '1', 'Nirban', 'Acharjee', 'nirban@gmail.com', 'tcr-tcr20639030779631f-1670393975.jpg', NULL, NULL, 'tcr20639030779631f', 1, '2022-12-07 06:19:35', '2022-12-07 21:15:52'),
...
--
-- Indexes for table `mcq_responses`
--
...
--
-- Indexes for table `open_responses`
--
...
--
ALTER TABLE `enroll_students`
  MODIFY `enroll_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `mcq_responses`
--
ALTER TABLE `mcq_responses`
...
--
-- AUTO_INCREMENT for table `open_responses`
--
ALTER TABLE `open_responses`
  MODIFY `response_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
